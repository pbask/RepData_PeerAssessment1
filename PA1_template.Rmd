...
week <- wday(doc_copy_missing_filled$date)
week_day <- week
...
#plots
plot(x = avg_interval_weekday$interval, y = avg_interval_weekday$steps, type = "l") 
plot(x = avg_interval_weekend$interval, y = avg_interval_weekend$steps, type = "l") 
```
